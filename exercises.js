...
console.log('isGreaterThan ' + isGreaterThan(8, 4))
/*
 * #4
 * Function - mustBeTrue
...
console.log('isEqual ' + isEqual('happy', 'nappy'));
/*
 * #7
 * Function - notEqual
...
console.log('dirty30 ' + dirty30(9, 4, 10));
/*
 * #10
...
console.log('evenStevens ' + evenStevens(20));
console.log('evenStevens ' + evenStevens(21));
...
console.log('moneyTrain ' + moneyTrain(100));
console.log('moneyTrain ' + moneyTrain(40));
console.log('moneyTrain ' + moneyTrain(80));
...
console.log('dailySpecials ' + dailySpecials('Wednesday'));
...
var gamers = [1, 2, 3, 4, 5];
for(var i = 0; i < gamers.length; i++){
  console.log('Player ' + gamers[i])
} 
